...
public class ApiClient {
  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      ...
      if ("strava_oauth".equals(authName)) {
        auth = new OAuth(OAuthFlow.accessCode, "https://www.strava.com/api/v3/oauth/authorize", "https://www.strava.com/api/v3/oauth/token", "read, read_all, profile:read_all, profile:write, activity:read, activity:read_all, activity:write");
      } else {
